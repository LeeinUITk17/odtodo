...
class OrderItem(models.Model):
    _name = 'order.management.orderitem'
    ...
    order_id = fields.Many2one('order.management.order', string="Order", required=True)
    menu_item_id = fields.Many2one('menu.management.menuitem', string="Menu Item", required=True)
